...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            var methodSyntax = 
                Emps
                    .Max(e => e.Salary);                        
            // Query syntax
            var querySyntax = Emps.Where(e => e.Salary == methodSyntax);
            IEnumerable<Emp> result = querySyntax;
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            var querySyntax =
                ...
                group new { emp, dept } by dept.Dname into deptGroup
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            var querySyntax =
                ...
                let numEmployees = empGroup.Count()
                where numEmployees == 5 || numEmployees == 0
                orderby dept.Dname
                select dept;
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> Task15(this IEnumerable<Emp> emp)
        {
            var methodSyntax = emp
                .Where(e =>emp.Any(e2=> e2.Mgr==e))
                .OrderBy(e => e.Ename)                        
